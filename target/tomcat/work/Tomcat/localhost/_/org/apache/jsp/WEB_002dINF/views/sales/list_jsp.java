 ...
 * Generated at: 2016-07-17 02:03:49 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <h3 class=\"box-title\">销售列表</h3>\r\n");
      ...
      out.write("                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span\r\n");
      out.write("                        aria-hidden=\"true\">&times;</span></button>\r\n");
      out.write("                <h4 class=\"modal-title\">修改销售机会</h4>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"modal-body\">\r\n");
      ...
      out.write("                    <div class=\"form-group\">\r\n");
      out.write("                        <label>机会名称</label>\r\n");
      out.write("                        <input type=\"text\" name=\"name\" id=\"edit_name\" class=\"form-control\">\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"form-group\" id=\"editCustList\">\r\n");
      out.write("                        <label>关联客户</label>\r\n");
      out.write("                        <select class=\"form-control\" name=\"custid\" id=\"edit_custid\">\r\n");
      out.write("                           ");
      out.write("\r\n");
      out.write("                        </select>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"form-group\">\r\n");
      out.write("                        <label>销售价值</label>\r\n");
      out.write("                        <input type=\"text\" name=\"price\" id=\"edit_price\" class=\"form-control\">\r\n");
      out.write("                    </div>\r\n");
      out.write("\r\n");
      out.write("                    <div class=\"form-group\">\r\n");
      out.write("                        <label>当前进度</label>\r\n");
      out.write("                        <select class=\"form-control\" id=\"edit_progress\" name=\"progress\">\r\n");
      out.write("                            <option value=\"初次接触\">初次接触</option>\r\n");
      out.write("                            <option value=\"确认意向\">确认意向</option>\r\n");
      out.write("                            <option value=\"提供合同\">提供合同</option>\r\n");
      out.write("                            <option value=\"完成交易\">完成交易</option>\r\n");
      ...
      out.write("            <div class=\"modal-footer\">\r\n");
      out.write("                <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">取消</button>\r\n");
      out.write("                <button type=\"button\" class=\"btn btn-primary\" id=\"editBtn\">修改</button>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("                {\r\n");
      out.write("                    \"data\": function (row) {\r\n");
      out.write("                        return \"<a href='#' class='editLink' rel='\" + row.id + \"'>修改</a> \" ");
      ...
      out.write("            $.get(\"/sales/customer.json\", \"click\", function (data) {\r\n");
      out.write("                var $select = $(\"#custList select\");\r\n");
      out.write("                $select.html(\"\");\r\n");
      out.write("                $select.append('<option></option>');\r\n");
      out.write("                if (data && data.length) {\r\n");
      out.write("                    for (var i = 0; i < data.length; i++) {\r\n");
      out.write("                        var cust = data[i];\r\n");
      out.write("                        var option = \"<option value='\" + cust.id + \"'>\" + cust.name + \"</option>\";\r\n");
      out.write("                        $select.append(option);\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("            }).fail(function () {\r\n");
      out.write("                alert(\"服务器运行异常\");\r\n");
      out.write("            });\r\n");
      ...
      out.write("            },\r\n");
      out.write("            submitHandler: function (form) {\r\n");
      out.write("                $.post(\"/sales/edit\", $(form).serialize()).done(function (data) {\r\n");
      out.write("                    if (data == \"success\") {\r\n");
      out.write("                        $(\"#editModal\").modal(\"hide\");\r\n");
      out.write("                        dataTable.ajax.reload();\r\n");
      out.write("                        //alert(\"客户修改成功\");\r\n");
      out.write("                    }\r\n");
      out.write("                }).fail(function () {\r\n");
      out.write("                    alert(\"服务器异常\");\r\n");
      out.write("                });\r\n");
      ...
      out.write("            var $select = $(\"#editCustList select\");\r\n");
      out.write("            $select.html(\"\");\r\n");
      out.write("            $select.append(\"<option></option>\");\r\n");
      out.write("\r\n");
      out.write("            $.get(\"/sales/edit/\" + id + \".json\").done(function (data) {\r\n");
      out.write("\r\n");
      out.write("                if (data.state == \"success\") {\r\n");
      out.write("                    if(data.customerList && data.customerList.length) {\r\n");
      out.write("                        for(var i = 0;i < data.customerList.length;i++) {\r\n");
      out.write("                            var customer = data.customerList[i];\r\n");
      out.write("                            var option = \"<option value='\"+customer.id+\"'>\"+customer.name+\"</option>\";\r\n");
      out.write("                            $select.append(option);\r\n");
      out.write("                        }\r\n");
      out.write("                    }\r\n");
      out.write("                    var sales = data.sales;\r\n");
      out.write("\r\n");
      out.write("                    $(\"#edit_id\").val(sales.id);\r\n");
      out.write("                    $(\"#edit_name\").val(sales.name);\r\n");
      out.write("                    $(\"#edit_price\").val(sales.price);\r\n");
      out.write("                    $(\"#edit_progress\").val(sales.progress);\r\n");
      out.write("\r\n");
      out.write("                    $select.val(sales.custid);\r\n");
      out.write("\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/sales/list.jsp(95,28) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/sales/list.jsp(95,28) '${custList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${custList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/sales/list.jsp(95,28) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_shiro_005fhasRole_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/sales/list.jsp(216,91) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_shiro_005fhasRole_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write(" +\r\n");
        out.write("                                \"<a href='#' class='delLink' rel='\" + row.id + \"'>删除</a>\"");
  ...
  private boolean _jspx_meth_shiro_005fhasRole_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/sales/list.jsp(299,8) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_shiro_005fhasRole_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("            if (confirm(\"确定要删除销售机会及关联的数据吗？\")) {\r\n");
        out.write("                var id = $(this).attr(\"rel\");\r\n");
        out.write("                $.get(\"/sales/del/\" + id).done(function (data) {\r\n");
